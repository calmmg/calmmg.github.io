...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['flashlightpic1.png','flashlightpic2.webp','flashlightpic3.webp','flashlightpic4.webp'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				...
				k5.innerHTML="3499";//改变初始价格
				k6.innerHTML="2989";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="4399";//改变初始价格
				k4.innerHTML="12GB+512GB";//改变顶部标题文本
				k6.innerHTML="3989";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			k3.onclick=function(){
				...
				k5.innerHTML="3999";//改变初始价格
				k6.innerHTML="3589";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
