...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['小光X3one.png','小光x3two.png','小光x3three.png'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				...
				k5.innerHTML="4499";//改变初始价格
				k6.innerHTML="4439";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			k3.onclick=function(){
				...
				k5.innerHTML="4699";//改变初始价格
				k6.innerHTML="4689";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
