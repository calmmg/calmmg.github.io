...
function allauto()
{
		...
		var imgarry=['watchblue1.webp','watchblue2.png','watchblue3.png','watchblue4.png'];
...
function selected()
		{
			...
			k1.onclick=function()
			{
				k4.innerHTML="42mm eSIM  版";//改变顶部标题文本
				k5.innerHTML="1499";//改变初始价格
				k6.innerHTML="1489";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="1299";//改变初始价格
				k4.innerHTML="42mm 蓝牙 版";//改变顶部标题文本
				k6.innerHTML="1289";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			var count=0;
			k3.onclick=function(){
				k4.innerHTML="46mm eSIM 版";//改变顶部标题文本
