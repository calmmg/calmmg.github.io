...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['p50black1.png','p50black2.png','p50black3.png','p50black4.png'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				...
				k5.innerHTML="3699";//改变初始价格
				k6.innerHTML="3389";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="4599";//改变初始价格
				k4.innerHTML="12GB+512GB";//改变顶部标题文本
				k6.innerHTML="4588";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			k3.onclick=function(){
				...
				k5.innerHTML="3899";//改变初始价格
				k6.innerHTML="3889";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
