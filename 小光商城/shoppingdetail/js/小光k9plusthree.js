...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['9whitepic1.webp','9whitepic2.webp','9whitepic3.webp','9whitepic4.webp'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				k4.innerHTML="8G+256G";//改变顶部标题文本
				k5.innerHTML="1799";//改变初始价格
				k6.innerHTML="1399";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="2599";//改变初始价格
				k4.innerHTML="12G+512G";//改变顶部标题文本
				k6.innerHTML="2489";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			var count=0;
			k3.onclick=function(){
				k4.innerHTML="12G+256G";//改变顶部标题文本
				k5.innerHTML="1999";//改变初始价格
				k6.innerHTML="1989";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
