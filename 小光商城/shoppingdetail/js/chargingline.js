...
function allauto()
{
		...
		var imgarry=['charginglinepic1.png','charginglinepic2.png','charginglinepic3.webp','charginglinepic4.webp'];
...
function selected()
		{
			...
			k1.onclick=function()
			{
				...
				// k5.innerHTML="2499";//改变初始价格
				// k6.innerHTML="2389";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
