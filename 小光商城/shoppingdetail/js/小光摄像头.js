...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['hand1.webp','hand2.jpg','hand3.jpg','hand4.png'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				k4.innerHTML="300万超清";//改变顶部标题文本
				k5.innerHTML="179";//改变初始价格
				k6.innerHTML="99";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="229";//改变初始价格
				k4.innerHTML="400万高清";//改变顶部标题文本
				k6.innerHTML="169";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
