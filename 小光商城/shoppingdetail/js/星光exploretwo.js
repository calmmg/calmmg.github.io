...
function allauto()
{
		...
		var imgarry=['exwhite1.png','exwhite2.webp','exwhite3.webp','exwhite4.png'];
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="2399";//改变初始价格
				k4.innerHTML="12G+512G";//改变顶部标题文本
				k6.innerHTML="2298";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectedse()
		{
			...
			k3.onclick=function(){
				...
				k5.innerHTML="2199";//改变初始价格
				k6.innerHTML="2189";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
