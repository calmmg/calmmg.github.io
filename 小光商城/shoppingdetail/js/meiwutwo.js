...
function allauto()
{
		...
		// 	}
			...
			var imgarry=['meiwutwopic1.png','meiwutwopic4.webp','meiwutwopic3.webp','meiwutwopic2.webp'];//创建图片数组路径
...
function selected()
		{
			...
			k1.onclick=function()
			{
				k4.innerHTML="43英寸";//改变顶部标题文本
				k5.innerHTML="1199";//改变初始价格
				k6.innerHTML="989";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selecteds()
		{
			...
			var count=0;
			k2.onclick=function(){
				k5.innerHTML="1399";//改变初始价格
				k4.innerHTML="50英寸";//改变顶部标题文本
				k6.innerHTML="1389";//改变打折后的价格
				count=count+1;
				if(count%2==0)
				{
...
function selectcolor()
		{
			...
			{
				// k4.innerHTML="黑釉";
				// k5.src='../img/X5black1.jpg';//改变图片
				// k6.src='../img/X5black2.png';
				// k7.src='../img/X5black3.jpg';
				// k8.src='../img/X5black4.png';
				count=count+1;
				if(count%2==0)
				{
					k1.style="border-color:#C7C7C7;color:black";
