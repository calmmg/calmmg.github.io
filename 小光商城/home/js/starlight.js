...
//单机轮播图跳转详情页面
function jumpone()
{window.location.href='../../shoppingdetail/page/星光exploreone.html';}
function jumptwo()
{window.location.href='../../shoppingdetail/page/星光watchT1.html';}
...
function rechangecarcolor()
{
	var car=document.getElementById("smallcar");
	var gwc=document.getElementById("gwc");
	gwc.onmouseout=function(){car.style.color="black"};
}
