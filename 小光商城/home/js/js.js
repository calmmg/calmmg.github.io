...
//单机轮播图跳转详情页面
function jumpone()
{window.location.href='../../shoppingdetail/page/星光耳机2two.html';}
function jumptwo()
{window.location.href='../../shoppingdetail/page/小光耳机fix3.html';}
function jumpthree()
{window.location.href='../../shoppingdetail/page/小光x3.html';}
function jumpfour()
{window.location.href='../../shoppingdetail/page/光幻airyouthtwo.html';}
function jumpfive()
{window.location.href='../../shoppingdetail/page/starlightwatch2.html';}
...
function allauto()
{
		...
		// var imgArr=['old.png','newpic2.webp','two.jpg','one.jpg','three.jpg','fourr.jpg'];//创建数组存放图片路径
...
function move_one()
{
	...
	card.style="position: relative;top: -3px;cursor: pointer";
}
function remove_one()
{
...
function move_five()
{
	...
	pic2.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_six()
{
	...
	pic3.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_six()
{
	var pic3=document.getElementById('pic3');
...
function move_seven()
{
	...
	pic4.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_eight()
{
	...
	pic5.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_nine()
{
	...
	pic6.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
