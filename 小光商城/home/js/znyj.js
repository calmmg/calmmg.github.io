...
//单机轮播图跳转详情页面
function jumpone()
{window.location.href='../../shoppingdetail/page/小光耳机fix3.html';}
function jumptwo()
{window.location.href='../../shoppingdetail/page/星光4Tone.html';}
...
function allauto()
{
		...
		// var imgArr=['two.jpg','yjlb2.jpg'];//创建数组存放图片路径
...
function move_one()
{
	...
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_one()
{
...
function move_three()
{
	...
	var pic1=document.getElementById('pic3');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_four()
{
	...
	var pic1=document.getElementById('pic4');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_five()
{
	...
	var pic1=document.getElementById('pic5');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
...
function move_six()
{
	...
	var pic1=document.getElementById('pic6');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_six()
{
	var card=document.getElementById('pic6');
	card.style="none";
}
function move_seven()
{
	
	var pic1=document.getElementById('pic7');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_seven()
{
	var card=document.getElementById('pic7');
	card.style="none";
}
function move_eight()
{
	
	var pic1=document.getElementById('pic8');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_eight()
{
	var card=document.getElementById('pic8');
	card.style="none";
}
...
function move_nine()
{
	...
	var pic1=document.getElementById('pic9');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_nine()
{
	var card=document.getElementById('pic9');
	card.style="none";
}
function move_ten()
{
...
function remove_ten()
{
	var card=document.getElementById('pic10');
	card.style="none";
}
function move_eleven()
{
	
	var pic1=document.getElementById('pic11');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_eleven()
{
	var card=document.getElementById('pic11');
	card.style="none";
}
function move_twelve()
{
	
	var pic1=document.getElementById('pic12');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twelve()
{
	var card=document.getElementById('pic12');
	card.style="none";
}
function move_thirteen()
{
	
	var pic1=document.getElementById('pic13');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_thirteen()
{
	var card=document.getElementById('pic13');
	card.style="none";
}
function move_fourteen()
{
	
	var pic1=document.getElementById('pic14');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_fourteen()
{
	var card=document.getElementById('pic14');
	card.style="none";
}
function move_fifteen()
{
	
	var pic1=document.getElementById('pic15');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_fifteen()
{
	var card=document.getElementById('pic15');
	card.style="none";
}
function move_sixteen()
{
	
	var pic1=document.getElementById('pic16');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_sixteen()
{
	var card=document.getElementById('pic16');
	card.style="none";
}
function move_seventeen()
{
	
	var pic1=document.getElementById('pic17');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_seventeen()
{
	var card=document.getElementById('pic17');
	card.style="none";
}
// 智能电视移动效果
function move_eighteen()
{
	
	var pic1=document.getElementById('pic18');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_eighteen()
{
	var card=document.getElementById('pic18');
	card.style="none";
}
function move_nineteen()
{
	
	var pic1=document.getElementById('pic19');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_nineteen()
{
	var card=document.getElementById('pic19');
	card.style="none";
}
function move_twenty()
{
	
	var pic1=document.getElementById('pic20');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twenty()
{
	var card=document.getElementById('pic20');
	card.style="none";
}
function move_twentyone()
{
	
	var pic1=document.getElementById('pic21');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentyone()
{
	var card=document.getElementById('pic21');
	card.style="none";
}
// 周边配件
function move_twentytwo()
{
	
	var pic1=document.getElementById('pic22');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentytwo()
{
	var card=document.getElementById('pic22');
	card.style="none";
}
function move_twentythree()
{
	
	var pic1=document.getElementById('pic23');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentythree()
{
	var card=document.getElementById('pic23');
	card.style="none";
}
function move_twentyfour()
{
	
	var pic1=document.getElementById('pic24');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentyfour()
{
	var card=document.getElementById('pic24');
	card.style="none";
}
function move_twentyfive()
{
	
	var pic1=document.getElementById('pic25');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentyfive()
{
	var card=document.getElementById('pic25');
	card.style="none";
}
function move_twentysix()
{
	
	var pic1=document.getElementById('pic26');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentysix()
{
	var card=document.getElementById('pic26');
	card.style="none";
}
function move_twentyseven()
{
	
	var pic1=document.getElementById('pic27');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentyseven()
{
	var card=document.getElementById('pic27');
	card.style="none";
}
function move_twentyeight()
{
	
	var pic1=document.getElementById('pic28');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentyeight()
{
	var card=document.getElementById('pic28');
	card.style="none";
}
function move_twentynine()
{
	
	var pic1=document.getElementById('pic29');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_twentynine()
{
	var card=document.getElementById('pic29');
	card.style="none";
}
function move_thirty()
{
	
	var pic1=document.getElementById('pic30');
	pic1.style="position: relative;top: -2px;box-shadow: 0px 2px 10px #d1d1c8;";
}
function remove_thirty()
{
	var card=document.getElementById('pic30');
	card.style="none";
}